...
{
    public class CommandContextForCommandMethodsTests : TestBase
    {
        public CommandContextForCommandMethodsTests(ITestOutputHelper testOutputHelper) : base(testOutputHelper)
        {
        }
