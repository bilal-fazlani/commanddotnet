...
exthelp2"
    ...
    [Command(Description = "", DescriptionLines = [""])]
    private class DupeDescriptions { }

    [Command(Usage = "", UsageLines = [""])]
    private class DupeUsages { }

    [Command(ExtendedHelpText = "", ExtendedHelpTextLines = [""])]
    ...
    private class App
    {
        ...
        [Command(
            DescriptionLines = ["descr1", "descr2"],
            UsageLines = ["usage1", "usage2"],
            ExtendedHelpTextLines = ["exthelp1", "exthelp2"])]
