...
public sealed class SuggestionRankingExtensionsTests(ITestOutputHelper output) : IDisposable
{
    private readonly IDisposable _cleanup = TestToolsLogProvider.InitLogProvider(output.WriteLine);
