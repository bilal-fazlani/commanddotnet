...
{
    public class OverridingDefaultValuesScenarios
    {
        private readonly ITestOutputHelper _testOutputHelper;

        public OverridingDefaultValuesScenarios(ITestOutputHelper testOutputHelper)
        {
                ...
                .VerifyScenario(_testOutputHelper,
                    new Scenario
                    {
                        ...
                        Then =
                        {
                            ...
                            {
                                "Property:OptionsDefaultsSampleTypesModel.StructNArg > StructNArg(System.Nullable`1[System.Int32])",
