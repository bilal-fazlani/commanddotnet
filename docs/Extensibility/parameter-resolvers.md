...
!!! tip
    Use `IConsole` in your methods instead of Console to simplify unit tests. [TestConsole](../TestTools/test-tools.md#testconsole) captures output and can mimic  input.  
