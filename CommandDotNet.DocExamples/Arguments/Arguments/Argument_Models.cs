...
public class Argument_Models
{
    ...
    public static readonly BashSnippet Help_WithoutModel = new("argument_models_notify_without_model_help",
...
Options:
  ...
  -q | --quiet");
    ...
    public static readonly BashSnippet Help_WithModel = new("argument_models_notify_with_model_help",
...
Options:
  ...
  -q | --Quite");
    ...
    public static readonly BashSnippet Help_WithModelComposed = new("argument_models_notify_with_model_composed_help",
        new AppRunner<Program_WithComposedModel>(), "myapp.exe", "Notify --help", 0,
        Help_WithModel.Output);

    public static readonly BashSnippet Help_WithInterceptor = new("argument_models_notify_with_interceptor_help",
...
Options:
  ...
  -q | --Quite");
    ...
    public static readonly BashSnippet Help_WithNestedOperands = new("argument_models_notify_with_nested_operands_help",
...
Options:
  ...
  -q | --Quite");
    ...
    public static readonly BashSnippet Help_WithInvalidNestedOperands = new("argument_models_notify_with_invalid_nested_operands_help",
