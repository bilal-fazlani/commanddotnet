...
namespace CommandDotNet.TestTools.Prompts
{
    ...
    public static class Respond
    {
        ...
        public static IPromptResponder FailOnPrompt { get; } = new FailOnPromptResponder();
        ...
        public static IPromptResponder With(string answer, Predicate<string> promptFilter = null, bool reuse = false) =>
            new PromptResponder(new Answer(answer, promptFilter, reuse).ToEnumerable());
        ...
        public static IPromptResponder WithList(string[] answers, Predicate<string> promptFilter = null, bool reuse = false) =>
            new PromptResponder(new Answer(answers, promptFilter, reuse).ToEnumerable());
