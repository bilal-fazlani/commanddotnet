...
public class SystemConsole : IConsole
{
    ...
    {
        [SupportedOSPlatform(Windows)] get => SysConsole.Title;
    ...
    [SupportedOSPlatform(Windows)] public virtual bool NumberLock => SysConsole.NumberLock;

    [SupportedOSPlatform(Windows)] public virtual bool CapsLock => SysConsole.CapsLock;
    ...
    public virtual int BufferWidth
    {
        ...
        [SupportedOSPlatform(Windows)] set => SysConsole.BufferWidth = value;
    }

    public virtual int BufferHeight
    {
        get => SysConsole.BufferHeight;
        [SupportedOSPlatform(Windows)] set => SysConsole.BufferHeight = value;
    }
    ...
    public virtual int WindowLeft
    {
        ...
        [SupportedOSPlatform(Windows)] set => SysConsole.WindowLeft = value;
    }

    public virtual int WindowTop
    {
        get => SysConsole.WindowTop;
        [SupportedOSPlatform(Windows)] set => SysConsole.WindowTop = value;
    }

    public virtual int WindowWidth
    {
        get => SysConsole.WindowWidth;
        [SupportedOSPlatform(Windows)] set => SysConsole.WindowWidth = value;
    }

    public virtual int WindowHeight
    {
        get => SysConsole.WindowHeight;
        [SupportedOSPlatform(Windows)] set => SysConsole.WindowHeight = value;
    }
    ...
    public virtual int CursorSize
    {
        ...
        [SupportedOSPlatform(Windows)] set => SysConsole.CursorSize = value;
    }

    public virtual bool CursorVisible
    {
        [SupportedOSPlatform(Windows)] get => SysConsole.CursorVisible;
