    ...
    : IIndentableToString
{
    ...
    public OriginalInput Original { get; } = new(originalArgs, originalTokens);
    ...
    /// </summary>
    public TokenCollection Tokens { get; set; } = originalTokens;
    ...
    public IConsole Console { get; set; } = appConfig.Console;

    /// <summary>The <see cref="IEnvironment"/>, defaulted from <see cref="Execution.AppConfig.Environment"/>.</summary>
    public IEnvironment Environment { get; set; } = appConfig.Environment;
    ...
    /// </summary>
    public IServices Services { get; } = new Services(appConfig.Services);
