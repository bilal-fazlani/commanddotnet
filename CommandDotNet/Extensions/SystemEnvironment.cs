...
public class SystemEnvironment : IEnvironment
{
    ...
    public virtual string FrameworkDescription => RuntimeInformation.FrameworkDescription.Trim();
    ...
    public virtual string OSDescription => RuntimeInformation.OSDescription.Trim();
