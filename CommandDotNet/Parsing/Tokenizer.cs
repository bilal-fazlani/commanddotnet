    ...
    public static class Tokenizer
    {
        ...
        private static IEnumerable<Token> ParseTokens(string[] args, bool includeDirectives)
        {
            ...
            foreach (var arg in args)
            {
                if (foundSeparator)
                {
                    yield return new Token(arg, arg, TokenType.Argument);
                }

                var token = ParseToken(arg, includeDirectives);
        ...
        private static Token ParseToken(string arg, bool includeDirectives)
        {
            ...
            return new Token(arg, arg, TokenType.Argument);
        }
    }
}