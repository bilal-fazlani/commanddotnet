...
public static class ParseReporter
{
    ...
    private record TokenValues(Token? ValueToken, Token? OptionToken)
    {
        public bool HasSourceToken => ValueToken?.SourceToken is not null || OptionToken?.SourceToken is not null;
    }
}