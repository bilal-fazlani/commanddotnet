...
namespace CommandDotNet.Execution
{
    ...
    public enum MiddlewareStages
    {
        ...
        /// or need to register event handlers early in the pipeline.<br/>
        /// Guarantees:<br/>
        ...
        /// <summary>
        /// In the <see cref="Build"/> stage commands and arguments are determined from the type specified in <see cref="AppRunner{T}"/>.<br/>
        /// Guarantees:<br/>
        ...
        /// intended command, options and operands and separated arguments.<br/>
        /// Guarantees:<br/>
